...
#define PLR_GOSSIP      16
#define PLR_AUCTION     32
#define PLR_LOG         64 /* log activities of this player. */
#define PLR_FREEZE     128 /* No commands available */

#define KAL_COLOR        1 /* Toggle for color */
#define KAL_IMMLINE      2 /* Toggle wizline on and off */
#define KAL_DEILINE      4 /* Toggle the deity line on and off */
#define KAL_SUPLINE	 8 /* Toggle the supreme line on and off */
#define KAL_GODLINE	 16 /* Toggle the god line on and off */
#define TAL_CONNECT	 32 /* Wizards connecting messages */
#define TAL_EXIT	 64 /* Wizards message when players leave */
#define TAL_DEATH	128 /* Wizards messages at player deaths */
#define TAL_HACKS	 256 /* Wizard messages when ppl hack */
...
#define CHA_SHOUT        4
#define CHA_GOSSIP       5
#define CHA_AUCTION      6
#define MAX_COL_CHAN     7
...
struct char_special_data
{
    ...
    bool unused;
    struct attack_data attack[MAX_ATTACKS];
};

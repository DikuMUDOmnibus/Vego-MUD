...
#define GET_CL(ch)      ((ch)->player.cl)

#define GET_MM(ch)      ((ch)->player.cl[CLASS_MAGE])

#define GET_CC(ch)      ((ch)->player.cl[CLASS_CLERIC])

#define GET_TT(ch)      ((ch)->player.cl[CLASS_THIEF])

#define GET_WW(ch)      ((ch)->player.cl[CLASS_WARRIOR])
...
#define PERS(ch, vict)   (                                          \
    CAN_SEE(vict, ch)||GET_LEVEL(ch)>31 ?                                             \
